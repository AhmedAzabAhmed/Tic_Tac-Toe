...
public  class MatchResultBase extends AnchorPane {
    ...
    public MatchResultBase(Stage s, int flag) {
        this.flag =flag;
        ...
        imageView.setImage(new Image(getClass().getResource("Images/m.gif").toExternalForm()));

        text.setFill(javafx.scene.paint.Color.valueOf("#fdfdfd"));
        text.setFontSmoothingType(javafx.scene.text.FontSmoothingType.LCD);
        text.setLayoutX(41.0);
        text.setLayoutY(178.0);
        text.setStrokeType(javafx.scene.shape.StrokeType.OUTSIDE);
        text.setStrokeWidth(0.0);
        text.setText("Game Set Match");
